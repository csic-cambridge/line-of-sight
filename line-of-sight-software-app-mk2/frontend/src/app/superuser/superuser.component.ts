...
export class SuperuserComponent implements OnInit, AfterViewInit {
    ...
    @ViewChild('elUserEmail') elUserEmail!: ElementRef;
    ...
    userChange(e: any): void {
        const userEmailString = e.target.value;
        this.selectedUser = this.users.find(user => user.email_address === userEmailString);
        this.setSuperUserStatus();
        this.getUserPermissions();
        this.enableFormContent(userEmailString, this.elUserEmail);
    }
    ...
    clearUserContent(): void {
        ...
        this.resetFormContentState(this.elUserEmail);
        this.updateIsChangeSelectedForSuperUserStatus();
        this.updateIsChangeSelectedForUserPermissions();
    }
