 ...
 */
public class UserAndPermissionId implements Serializable {
    private static final long serialVersionUID = 1L;

    public UserAndPermissionId(UUID userId, Integer permissionId) {
        this.userId = userId;
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        UserAndPermissionId that = (UserAndPermissionId) o;
