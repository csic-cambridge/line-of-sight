...
import com.costain.cdbb.model.helpers.OriganisationalObjectiveHelper;
...
public class OrganisationalObjectivesApiDelegateImpl implements OrganisationalObjectivesApiDelegate {
    ...
    private OriganisationalObjectiveHelper ooHelper;
    ...
    @Autowired
    public void setOoHelper(OriganisationalObjectiveHelper ooHelper) {
    ...
    @Override
    public Mono<ResponseEntity<OrganisationalObjectiveWithId>> upsertOrganisationalObjective(UUID id,
            Mono<OrganisationalObjective> organisationalObjective, ServerWebExchange exchange) {
